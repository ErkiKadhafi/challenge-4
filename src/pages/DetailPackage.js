...
const DisclosureBtn = (props) => (
  <div className="flex items-center justify-between ">
    <span className="font-bold">Refund, Reschedule, Overtime</span>
    {props.open ? (
      <svg
        width="24"
        height="24"
      ...
      <section className="pt-28">
        ...
        >
          <div className="col-span-3">
            <div
              className=" rounded-lg p-6 text-sm mb-6"
              style={{
                boxShadow: "0px 0px 4px rgba(0, 0, 0, 0.15)",
              }}
            >
              <h1 className="font-bold mb-4">Tentang Paket</h1>
              <div className="font-light mb-4">
                <p className="mb-2">Include</p>
                <ul className="text-gray-placeholder space-y-2 list-disc pl-5">
                  <li>
              ...
              <div className="font-light mb-7 text-sm">
            ...
            <button className="ml-auto block px-3 py-2 font-bold bg-green-primary text-white hover:bg-green-secondary hover:text-green-primary transition-all duration-200 rounded-sm">
          ...
          >
            <div className="flex justify-center items-center mb-4 ">
              <img src="./images/toyota_car.png" alt="car" />
            </div>
            <div className="mb-12">
            ...
            <div className="flex justify-between text-sm mb-6">
              ...
              <span className="font-bold">Rp 430.000</span>
            </div>
            <button className="w-full px-3 py-2 font-bold bg-green-primary text-white hover:bg-green-secondary hover:text-green-primary transition-all duration-200 rounded-sm">
              lanjutkan Pembayaran
            </button>
          </div>
        </div>
